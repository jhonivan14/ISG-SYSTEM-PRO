<html lang="en">
  ...
  <body class="bg-white text-black p-6">
    <div class="max-w-5xl mx-auto">
      <!-- Reused header from applicationProcess.html -->
      <header>
      ...
      <!-- Report lines per sample -->
      <p class="text-center text-xs -mt-2">
        Website: <a class="text-blue-700 underline" href="http://www.smccnasipit.edu.ph">www.smccnasipit.edu.ph</a>,
        Email: <a class="text-blue-700 underline" href="mailto:communications@smccnasipit.edu.ph">communications@smccnasipit.edu.ph</a>
      </p>
