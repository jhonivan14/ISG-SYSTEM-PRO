      ...
      <header class="bg-[#052c6a] text-white">
        <div class="mx-auto flex max-w-3xl items-center justify-between px-4 py-3">
          <div class="text-xs">
            ...
            <p class="text-[11px] text-blue-100">Head of Office Change Password</p>
          </div>
          <div class="flex items-center gap-2 text-xs">
            <span class="text-[11px] text-blue-100"><?= htmlspecialchars($headName) ?></span>
            <button
              class="rounded-full border border-white/40 px-3 py-1 text-[11px] hover:bg-white/10"
              type="button"
              onclick="window.location.href='headDashboard.php'"
            >
              Back
            </button>
          </div>
